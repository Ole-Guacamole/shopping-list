...
router.delete('/user-shopping-list-links/:userId/:shoppingListId', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId, shoppingListId } = req.params;
    try {
        const deletedLink = yield db_1.prisma.userShoppingListLink.delete({
            where: {
                userId_shoppingListId: {
                    userId,
                    shoppingListId,
